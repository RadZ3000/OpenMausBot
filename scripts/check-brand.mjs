...
export const INCOMPLETE = [
  ...
  { slot: "publish", file: ".github/workflows/release.yml", count: 29, reason: "upstream release workflow still names their feed and product" },
  { slot: "productName", file: "apps/docs/README.md", count: 5, reason: "docs site still names the upstream product" },
  ...
  { slot: "productName", file: "apps/docs/content/docs/changelog/index.mdx", count: 10, reason: "docs site still names the upstream product" },
  ...
  { slot: "productName", file: "apps/docs/content/docs/computers/local-vm.mdx", count: 3, reason: "docs site still names the upstream product" },
  ...
  { slot: "productName", file: "apps/docs/content/docs/troubleshooting/updates.mdx", count: 3, reason: "docs site still names the upstream product" },
  ...
  { slot: "companionName", file: "ios/App/SettingsView.swift", count: 3, reason: "iOS settings copy still names OpenMausMobile / OpenMausBot" },
  ...
  { slot: "companionName", file: "ios/README.md", count: 2, reason: "iOS readme still names the upstream product" },
