...
const TOOLS = [
  {
    name: "list_bots",
    description:
      `List the other bots (agents) in your ${PRODUCT_NAME} section you can message, with their model and whether they're busy. Call this before ask_bot to discover who's available.`,
  ...
  },
  {
    ...
    description:
      "Ask the user for a supported API key through this app's secure credential card. Use this instead of asking them to paste a secret into chat. The secret is saved by the desktop app and is never returned to you. After calling this tool, end the turn; the app resumes the task after the user saves or declines.",
    inputSchema: {
      type: "object",
      properties: {
        credential_id: {
